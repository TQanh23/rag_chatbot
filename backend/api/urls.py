...
from .views import AskView, FileUploadView, PDFUploadView, InitQdrantView, DeleteQdrantCollectionView
...
urlpatterns = [
    ...
    path('upload/', FileUploadView.as_view()),  # New upload endpoint
